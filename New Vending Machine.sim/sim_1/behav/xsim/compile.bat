...
REM
REM Generated by Vivado on Wed Jan 14 20:47:33 -0500 2026
...
echo "xvhdl --incr --relax -prj Vend_SSEG_Driver_tb_vhdl.prj"
call xvhdl  --incr --relax -prj Vend_SSEG_Driver_tb_vhdl.prj -log xvhdl.log
